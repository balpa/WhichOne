...
function DMSettings({
    ...
    async function applyAndClose() {
        ...
        try {
            await AsyncStorage.setItem('chatBalloonColor', selectedColor);
        } // set color data to cache storage
        catch (e) {
            console.log(e);
        }

        try {
            await AsyncStorage.setItem('chatBalloonTextColor', selectedTextColor);
        } // set color data to cache storage
        catch (e) {
            console.log(e);
        }
        ...
        try {
            await AsyncStorage.setItem('isNameAboveBubbleEnabled', isEnabled.toString());
        } // set color data to cache storage
        catch (e) {
            console.log(e);
        }
